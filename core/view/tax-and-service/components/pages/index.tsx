...
} from '../../schemas/UpdateTaxSchema'
import { useGetTaxViewModel } from '../../view-models/GetTaxViewModel'
import { useUpdateTaxViewModel } from '../../view-models/UpdateTaxViewModel'
...
const ViewTaxAndServicePage = () => {
  ...
  const onSubmit: reactHookForm.SubmitHandler<ValidationSchemaUpdateTaxType> = (
    form,
  ) => {
