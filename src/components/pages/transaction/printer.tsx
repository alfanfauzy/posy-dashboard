...
export const printer = render(receipt)

// const port = window !== undefined ? window.navigator.serial.requestPort() : ''
// port.open({ baudRate: 9600 })

// export const writer = port.writable?.getWriter()
// if (writer != null) {
