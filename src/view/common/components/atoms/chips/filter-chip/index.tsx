...
const AtomsFilterChip = ({
	...
	<div
		...
		role="button"
		onClick={onClick}
		className={`${className} flex items-center gap-2 rounded-full border px-2 py-1.5 text-s-semibold bg-neutral-10 text-neutral-80 transition-all duration-100 ease-in-out ${
